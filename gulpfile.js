...
gulp.task('sass', function() {
    return gulp.src('collection/static/scss/*.scss').pipe(sass())
        .pipe(gulp.dest('collection/static/css'));
});
// Concatenate
gulp.task('scripts', function() {
    return gulp.src('collection/static/js/*.js')
        .pipe(concat('all.js')).pipe(gulp.dest('collection/static/js'));
});
// PostCSS processor
gulp.task('css', function() {
    ...
    return gulp.src('collection/static/css/*.css').pipe(postcss(processors)).pipe(gulp.dest('collection/static/css'))
});
